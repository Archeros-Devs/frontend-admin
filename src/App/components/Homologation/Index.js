                                    ...
                                    <tbody>
                                        ...
                                        this.state.pasta_homologar.map((pasta, id) =>
                                            <tr className="unread" key={pasta.id_pasta}>
                                                ...
                                                <td>
                                                    <button onClick={() => this.avaliar(pasta.id_pasta, +1)} style={{...pasta.avaliacao === 1 || pasta.avaliacao === null ? {background: '#28a745', color:'white' } : {}}} className={`btn-peruibe btn`}>Aprovar</button>
                                                    <button onClick={() => this.avaliar(pasta.id_pasta, -1)} style={{...pasta.avaliacao === -1 || pasta.avaliacao === null ? {background: '#dc3545', color:'white'} : {}}} className={`btn-peruibe_r btn `}>Reprovar</button>
                                                </td>
                                            </tr>
                                        )
                                        }
